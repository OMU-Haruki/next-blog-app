...
const Page: React.FC = () => {
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">カテゴリの編集・削除</h1>
      </div>
      ...
      <form
        ...
        className={twMerge("mb-8 space-y-6", isSubmitting && "opacity-50")}
      >
        <div className="space-y-4 rounded-md border border-slate-200 bg-white p-6 shadow-sm">
          <div className="space-y-1">
            <div className="block font-bold text-slate-700">現在のカテゴリの名前</div>
            <div className="text-slate-500">{currentCategoryName}</div>
          </div>
        ...
        <div className="flex flex-col-reverse gap-4 sm:flex-row sm:justify-end">
          <button
            type="button"
            className={twMerge(
              "rounded-md border border-red-500 px-5 py-2 font-bold text-red-500 transition-colors hover:bg-red-50"
            )}
          ...
          <button
            type="submit"
            className={twMerge(
              "rounded-md bg-indigo-500 px-5 py-2 font-bold text-white transition-colors hover:bg-indigo-600",
      ...
      <div className="space-y-2">
        <div className="text-xl font-bold">既存のカテゴリの一覧</div>
